  ...
  return (
    <div className='register'>
      <div className="row justify-content-center mt-5">
        <form onSubmit={(e) => register(e)} className="col-md-5 mt-5 text-left shadow-lg p-3 mb-5 bg-white rounded">
          ...
          <div>
            ...
            />
            <button className="btn btn-primary rounded-pill mt-3 mb-3">REGISTER</button>
            <br />
